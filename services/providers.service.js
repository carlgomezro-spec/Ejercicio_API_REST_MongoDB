...
const createProviderService = async (datosProvider) => {
...
const updateProviderService = async (companyName,datosEditarProvider)=>{
...
//lógica para que si eliminamos un proveedor -> en productos- provider :null
 const deleteProviderService = async (providerId) => {
